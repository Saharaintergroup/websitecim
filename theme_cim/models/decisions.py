...
class DecisionsCategory(models.Model):
    _name = "decisions.category"
    _description = "Decisions Category"
...
class Decisions(models.Model):
    ...
    category_id = fields.Many2one("decisions.category", string='التصنيف')
